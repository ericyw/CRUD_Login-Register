...
include_once( "Config/database.php" );
    ...
    function CheckIfAuthenticated() {
        ...
        if ( !isset( $_SESSION["is_logged_in"] ) ) {
            ...
            // if everything is ok, go to index page
    ...
    function Login( $username, $password ) {
        ...
        try {    
            $db = DBConnection();
            $query = "SELECT password, displayName FROM users WHERE username = :username"; // SQL statement
            ...
            if ( password_verify( $password, $hashed_password["password"] ) ) {
                ...
                // if everything is ok, go the index page
